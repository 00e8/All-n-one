...
// Apply `/farewell setup|config|reset` changes immediately instead of
...
cacheBus.on('invalidate:FarewellConfig', ({ guildId }) => {
    if (guildId) farewellConfigCache.delete(guildId);
});
