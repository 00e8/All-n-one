...
async function handle(interaction) {
  ...
  if (interaction.isStringSelectMenu()) {
    if (id === 'antinuke_setup_modules') {
      ...
      const allModules = ['antiBan', 'antiKick', 'antiChannelCreate', 'antiChannelDelete', 'antiChannelEdit', 'antiRoleCreate', 'antiRoleDelete', 'antiRoleUpdate', 'antiWebhook', 'antiBot', 'antiEmoji', 'antiGuildUpdate'];
        ...
        .addActionRowComponents(
          new ActionRowBuilder().addComponents(
            new StringSelectMenuBuilder()
              ...
              .addOptions(
                new StringSelectMenuOptionBuilder().setLabel('0 actions (Instant)').setValue('0').setDefault(config.threshold === 0),
        ...
        .addActionRowComponents(
          new ActionRowBuilder().addComponents(
            new StringSelectMenuBuilder()
              ...
              .setPlaceholder('Select threshold')
              .addOptions(
                new StringSelectMenuOptionBuilder().setLabel('0 actions (Instant)').setValue('0'),
          ...
          new ActionRowBuilder().addComponents(
            new StringSelectMenuBuilder()
              ...
              .addOptions(
                ...
                new StringSelectMenuOptionBuilder().setLabel('Anti-Channel Edit').setDescription('Prevent mass channel modifications').setValue('antiChannelEdit').setDefault(config.antiChannelEdit),
                ...
                new StringSelectMenuOptionBuilder().setLabel('Anti-Emoji').setDescription('Prevent emoji creation/deletion/modification').setValue('antiEmoji').setDefault(config.antiEmoji),
                new StringSelectMenuOptionBuilder().setLabel('Anti-Guild Update').setDescription('Prevent unauthorized server setting changes').setValue('antiGuildUpdate').setDefault(config.antiGuildUpdate)
              )
          )
        )
        .addActionRowComponents(
        ...
        .addActionRowComponents(
          new ActionRowBuilder().addComponents(
            new StringSelectMenuBuilder()
              ...
              .setPlaceholder('Select threshold')
              .addOptions(
                new StringSelectMenuOptionBuilder().setLabel('0 actions').setValue('0').setDefault(config.threshold === 0),
                new StringSelectMenuOptionBuilder().setLabel('2 actions').setValue('2').setDefault(config.threshold === 2),
                new StringSelectMenuOptionBuilder().setLabel('3 actions').setValue('3').setDefault(config.threshold === 3),
                new StringSelectMenuOptionBuilder().setLabel('5 actions').setValue('5').setDefault(config.threshold === 5),
                new StringSelectMenuOptionBuilder().setLabel('10 actions').setValue('10').setDefault(config.threshold === 10)
          ...
          new ActionRowBuilder().addComponents(
            new StringSelectMenuBuilder()
              ...
              .addOptions(
                ...
                new StringSelectMenuOptionBuilder().setValue('ban').setLabel('Ban').setDefault(config.punishment === 'ban')
              )
          )
        )
        .addActionRowComponents(
