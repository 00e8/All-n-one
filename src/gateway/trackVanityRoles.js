...
// Apply `/vanityroles` setup/reset immediately instead of waiting up to
// VANITY_CONFIG_TTL for the stale list of configured guilds to expire.
cacheBus.on('invalidate:vanityRoleConfig', () => {
    vanityConfigCache = null;
    vanityConfigCacheTs = 0;
});
