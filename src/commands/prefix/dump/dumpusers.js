...
module.exports = {
  ...
  async execute(message, args) {
    ...
    const loadingContainer = new ContainerBuilder()
      ...
      .addTextDisplayComponents(
        new TextDisplayBuilder().setContent(`-# Exporting all members...`)
      );
    ...
    try {
      const content = DumpExporter.formatMembers(message.guild, false, false);
      ...
      const dmContainer = new ContainerBuilder()
        ...
        .addTextDisplayComponents(
          new TextDisplayBuilder().setContent(`-# Here are the ${message.guild.members.cache.size} members from ${message.guild.name}.`)
        )
        .addFileComponents(
