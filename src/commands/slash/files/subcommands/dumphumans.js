...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const content = DumpExporter.formatMembers(interaction.guild, true, false);
      ...
      const dmContainer = new ContainerBuilder() 
        ...
        .addTextDisplayComponents(
          new TextDisplayBuilder().setContent(`-# Here are the ${humanCount} human members from ${interaction.guild.name}.`)
        )
        .addFileComponents(
