...
module.exports = {
    async execute(interactionOrMessage, args = []) {
        ...
        try {
            ...
            return reply(interactionOrMessage, 'Voice Unprivate', `-# Made ${channel.name} public. The channel is now visible.`);
        } catch (error) {
            ...
            return reply(interactionOrMessage, 'Error', `-# Failed to make channel public ${error.message}`);
        }
    }
};
