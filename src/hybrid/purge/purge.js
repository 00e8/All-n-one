...
module.exports = {
    ...
    async execute(interactionOrMessage, args = []) {
        ...
        if (!member.permissions.has(PermissionFlagsBits.ManageMessages))
            return reply(interactionOrMessage, '-# You need permission to use this command.', true);
        ...
        if (botPerms && !botPerms.has(PermissionFlagsBits.ManageMessages))
            return reply(interactionOrMessage, '-# I need permission in this channel.', true);
