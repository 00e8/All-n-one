...
const addIgnoredCommand = async (guildId, commandName) => {
    ...
    cacheBus.emit('invalidate:ignoredCommand', { guildId, commandName });
    return result;
};
...
const addIgnoredChannel = async (guildId, channelId) => {
    ...
    cacheBus.emit('invalidate:ignoredChannel', { guildId, channelId });
    return result;
};
...
const addIgnoredUser = async (guildId, userId) => {
    ...
    cacheBus.emit('invalidate:ignoredUser', { guildId, userId });
    return result;
};
...
const addBypassUser = async (guildId, userId) => {
    ...
    cacheBus.emit('invalidate:bypassUser', { guildId, userId });
    return result;
};
