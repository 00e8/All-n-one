...
const registry = {
  ...
  tickets: {
    ...
    commands: [
      { name: 'ticket panel',                description: 'Build and send the server\'s ticket panel (categories, logs, etc.)' },
      { name: 'ticket settings',             description: 'Configure prefix, staff roles, and the blacklist' },
      ...
      { name: 'ticket close',                description: 'Close and delete the current ticket' },
      { name: 'ticket blacklist add user', description: 'Blacklist a user from creating tickets' },
      { name: 'ticket blacklist remove user', description: 'Remove a user from the blacklist' },
      { name: 'ticket blacklist list',       description: 'List all blacklisted users' },
      { name: 'ticket help',                 description: 'Show a quick reference for the ticket system' },
    ]
  },
};
