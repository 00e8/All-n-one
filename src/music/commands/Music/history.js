    ...
    async execute(message, args, client, prefix) {
        ...
        if (history.length === 0) {
            const infoDisplay = new TextDisplayBuilder()
                .setContent(
                    ...
                    `-# Songs will appear here after they finish playing.`
                );
        ...
        const createContainer = (page) => {
            ...
            const headerDisplay = new TextDisplayBuilder()
                .setContent(`-# Recently Played Songs`);
            ...
            const footerDisplay = new TextDisplayBuilder()
                .setContent(`-# Page ${page + 1}/${totalPages} • ${history.length} songs`);
            ...
            const collector = historyMsg.createMessageComponentCollector({
                filter: (i) => {
                    ...
                    const errorDisplay = new TextDisplayBuilder()
                        .setContent(`-# Only ${message.author.tag} can use this button.`);
